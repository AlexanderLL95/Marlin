...
#define STRING_CONFIG_H_AUTHOR "Alexander Loquet" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Alexandros"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 294.79
  #define DEFAULT_bedKi 56.23
  #define DEFAULT_bedKd 386.40
 ...
 */
 ...
 //Custom code to do axis step calculation
//Raw values
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XY_STEPS, XY_STEPS, Z_STEPS, 95.0 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 24, 17, -1.45 }
